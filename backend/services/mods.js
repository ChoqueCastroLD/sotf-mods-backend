...
export async function getMods(page, limit, search, nsfw) {
...
export async function getModsFromUser(user_slug) {
    const mods = await prisma.mod.findMany({
        where: {
            user: {
                slug: user_slug,
...
export async function countModsFromUser(user_slug) {
...
export async function countMods(search, nsfw) {
    const where = {};
...
export async function getMod(mod_slug, author_slug, userWatching) {
...
export async function getModDownloadVersion(mod_slug, author_slug, version) {
...
export async function addDownload(modVersionId, ip, userAgent) {
